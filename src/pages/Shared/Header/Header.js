...
import logo from '../../../Images/camera-retro-solid.svg';
...
const Header = () => {
    ...
    return (
        <div className="navbar bg-primary text-white h-20 mb-16">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-200 rounded-box w-52">
                        <div><img src={logo} alt="" className=' mask mask-squircle w-8 h-8' />
                        ...
                        <div>
                            {
                                user?.email ?
                                    <> <li className='font-semibold'>
                                        ...
                                        <li className='font-semibold'>
                                            <Link to='/userreview'><button onClick={handleLogOut} className="btn btn-ghost">Sign Out</button></Link>
                                        </li>
                                    </>
                                    :
                                    <li className='font-semibold'><Link to='/login'><button className="btn btn-ghost">Sign Up</button></Link></li>
                            }
                        </div>
                    </ul>
                </div >
                <img src={logo} alt="" className=' mask mask-squircle w-8 h-8' />
                ...
                <div className=" menu menu-horizontal p-0 font-semibold">
                    {
                        user?.email ?
                            ...
                            :
                            <Link to='/login'><button className="btn btn-ghost">Sign Up</button></Link>
                    }
                </div>
            </div>
